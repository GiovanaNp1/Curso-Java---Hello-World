...
public class MenoreMaiorNumero {
    public static void main(String[] args){
        ...
        if(Numb1 < Numb2 & Numb1 < Numb3){
            System.out.println("O numero " + Numb1 + " é o menor numero");
        }else if(Numb2 < Numb1 && Numb2 < Numb3){
            System.out.println("O numero " + Numb2 + " é o menor numero");
        } else{
            System.out.println("O numero " + Numb3 + " é o menor numero");
        }
    }
}

// Faça um Programa que leia três números e mostre o maior e o menor deles. - CONCLUIDO
